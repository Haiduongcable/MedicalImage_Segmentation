...
from model.block import se_block, RDDB, resblock, gsc, Attention_B,\
    Attention_B, dual_att_blocks, Up3


def msrf(input_size=(384,512,3),input_size_2=(384,512,1)):
    n_labels=1
    feature_scale=8
